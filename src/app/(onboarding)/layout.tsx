  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-background p-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        ...
        <div
          className="animate-af-glow-pulse absolute -right-32 -top-32 size-[500px] rounded-full opacity-20 blur-[120px]"
          style={{ background: "radial-gradient(circle, var(--glow-cyan), transparent 65%)" }}
        />
        <div
          className="absolute -bottom-32 -left-32 size-[400px] rounded-full opacity-15 blur-[120px]"
